...
final orderChatProvider =
    StateNotifierProvider<OrderChatRepository>((ref) => OrderChatRepository());
final orderChatSendProvider = StateNotifierProvider<OrderChatSendRepository>(
...
/*Product- Chat*/
final productChatProvider = StateNotifierProvider<ProductChatRepository>(
    (ref) => ProductChatRepository());
final productChatSendProvider =
    StateNotifierProvider<ProductChatSendRepository>(
...
final conversationProvider =
    StateNotifierProvider<ConversationRepository>((ref) {
