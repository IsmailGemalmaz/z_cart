...
/*Provider*/
final blogsProvider = StateNotifierProvider<BlogsRepository>((ref) => BlogsRepository());
final blogProvider = StateNotifierProvider<BlogRepository>((ref) => BlogRepository());
