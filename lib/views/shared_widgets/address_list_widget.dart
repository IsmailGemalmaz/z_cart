...
class _AddressListBuilderState extends State<AddressListBuilder> {
  ...
  Widget build(BuildContext context) {
    print("Address list : ${widget.addressesList.first.city}");
                ...
                onTap: () {
                  if (widget.cartItem != null) {
                    if (accessAllowed) {
                      ...
                      context.read(checkoutNotifierProvider).addressId =
                          widget.addressesList[index].id;
                      context.read(checkoutNotifierProvider).shippingAddress =
