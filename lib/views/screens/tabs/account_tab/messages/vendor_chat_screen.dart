            ...
            child: Row(
              children: <Widget>[
                IconButton(
                  ...
                  icon: Icon(Icons.arrow_back, color: kDarkColor),
                ),
          ...
          children: [
            Expanded(
              child: Consumer(builder: (context, watch, _) {
                final _productChatState = watch(productChatProvider.state);
      ...
      child: Column(
        ...
        children: [
          Visibility(
            ...
            child: Text(
              "Subject: ${productChatModel.data.subject ?? "Hello"}",
              style: context.textTheme.caption
