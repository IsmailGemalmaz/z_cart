...
class VendorsDetailsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    final vendorDetailsState = watch(vendorDetailsNotifierProvider.state);
    final vendorItemDetailsListState = watch(vendorItemsNotifierProvider.state);
    final scrollControllerProvider = watch(vendorItemScrollNotifierProvider);

    return ProviderListener<ScrollState>(
      provider: vendorItemScrollNotifierProvider.state,
      onChange: (context, state) {
        if (state is ScrollReachedBottomState) {
          context.read(vendorItemsNotifierProvider).getMoreVendorItems();
        }
      },
      child: Scaffold(
        appBar: AppBar(
                  ...
                  ? Column(
                      children: [
                        ...
                        VendorCard(
                          ...
                          isVerified: vendorDetailsState.vendorDetails.verified,
