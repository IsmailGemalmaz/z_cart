                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text("Share", style: context.textTheme.overline)
                          .pOnly(top: 3)
                    ],
                  ...
                  Column(
                    children: [
                      ...
                      Text("Wishlist", style: context.textTheme.overline)
                          .pOnly(top: 3),
                    ],
                  ).onInkTap(() async {
                    toast("Adding to wish-list");
                    await context
                              ...
                              ? Container(
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      duration: Duration(seconds: 8),
                                      content:
                                          Text(productModel.data.conditionNote),
                                      shape: RoundedRectangleBorder(
                                          borderRadius: BorderRadius.only(
                                              topLeft: Radius.circular(10),
                                              topRight: Radius.circular(10))),
